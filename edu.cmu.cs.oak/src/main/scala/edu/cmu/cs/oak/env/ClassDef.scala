...
case class ClassDef(name: String, fields: List[String], methods: Map[String, FunctionDef], constants: Map[String, OakValue], staticFields: Map[String, OakValue],  parent: String) {
