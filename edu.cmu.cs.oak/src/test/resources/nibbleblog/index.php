...
if(file_exists(THEME_ROOT.'init.bit'))
	include('themes/medium/init.bit'); //include(THEME_ROOT.'init.bit');
	
	
//include('themes/medium/init.bit');
...
include('themes/medium/templates/default.bit') //require(THEME_TEMPLATES.$layout['template']);
?>