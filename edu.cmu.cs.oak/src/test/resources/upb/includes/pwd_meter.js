...
function runPassword(pwd) {
	var oComplexity = document.getElementById("u_pass_text");
	var nScore = 0;
	var nLength = 0;
	var nAlphaUC = 0;
	var nAlphaLC = 0;
    ...
    if (nScore >= 0 && nScore < 20) {
      if (pwd.length < nMinPwdLen)
        { sComplexity = "Too Short"; strColor = "#CC0033"; }
      else
        { sComplexity = "Very Weak"; strColor = "#CC0033"; }
    }
    else if (nScore >= 20 && nScore < 40) { sComplexity = "Weak"; strColor = "#CC0033";}
		else if (nScore >= 40 && nScore < 60) { sComplexity = "Good"; strColor = "#F8B500"}
		else if (nScore >= 60 && nScore < 80) { sComplexity = "Strong"; strColor = "#5a74e3"}
		else if (nScore >= 80 && nScore <= 100) { sComplexity = "Very Strong"; strColor = "#1740ef";}
		else if (nScore == "short") { sComplexity = "Too short"; strColor = "#1740ef";}
		
		/* Display updated score criteria to client */
		oComplexity.innerHTML = "<span style='color: " + strColor + ";'>" + sComplexity + "</span>";
	}
	else {
