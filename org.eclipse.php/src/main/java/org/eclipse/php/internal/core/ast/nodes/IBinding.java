...
public interface IBinding {
	...
	/**
	 * Kind constant (value 1) indicating a package binding. Bindings of this
	 * kind can be safely cast to <code>IPackageBinding</code>.
	 * 
	 * @see #getKind()
	 * @see IPackageBinding
	 */
	...
	/**
	 * Kind constant (value 5) indicating an annotation binding. Bindings of
	 * this kind can be safely cast to <code>IAnnotationBinding</code>.
	 * 
	 * @see #getKind()
	...
	/**
	 * Kind constant (value 6) indicating a member value pair binding. Bindings
	 * of this kind can be safely cast to <code>IMemberValuePairBinding</code>.
	 * 
	 * @see #getKind()
	 * @see IMemberValuePairBinding
	 * @since 3.2
	...
	/**
	 * Kind constant (value ) indicating a source binding. Bindings of this kind
	 * can be safely cast to <code>ISourceBinding</code>.
	 * 
	 * @see #getKind()
	 * @see ISourceBinding
	 * @since 3.2
	...
	/**
	 * Kind constant (value ) indicating an include binding. Bindings of this
	 * kind can be safely cast to <code>IIncludeBinding</code>.
	 * 
	 * @see #getKind()
	 * @see IIncludeBinding
	 * @since 3.2
	...
	/**
	 * Returns the name of this binding. Details of the name are specified with
	 * each specific kind of binding.
	 * 
	 ...
	 * binding. Within the context of a single cluster of bindings, each binding
	 * is represented by a distinct object. However, between different clusters
	 * of bindings, the binding objects may or may not be different objects; in
	 * these cases, the binding keys are used where available.
	 * 
	 * @param binding
	 *            the other binding, or <code>null</code>
	 * @return <code>true</code> if the given binding is the identical object as
	 *         this binding, or if the keys of both bindings are the same
	 *         string; <code>false</code> if the given binding is
