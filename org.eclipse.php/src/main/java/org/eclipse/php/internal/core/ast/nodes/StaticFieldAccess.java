...
public class StaticFieldAccess extends StaticDispatch {
	...
	public StaticFieldAccess(int start, int end, AST ast, Expression className,
			Variable field) {
	...
	ASTNode clone0(AST target) {
		...
		final StaticFieldAccess result = new StaticFieldAccess(getStart(),
				getEnd(), target, name, field);
		return result;
	}
