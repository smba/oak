...
public class Include extends Expression {
	...
	public static final SimplePropertyDescriptor INCLUDE_TYPE_PROPERTY = new SimplePropertyDescriptor(
			Include.class, "includeType", Integer.class, MANDATORY); //$NON-NLS-1$
	...
	ASTNode clone0(AST target) {
		...
		final Include result = new Include(getStart(), getEnd(), target, expr,
				type);
		return result;
	}
